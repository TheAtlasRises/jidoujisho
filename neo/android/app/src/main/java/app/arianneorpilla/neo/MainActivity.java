...
package app.arianneorpilla.neo;
...
public class MainActivity extends AudioServiceActivity {
    private static final String ANKIDROID_CHANNEL = "app.arianneorpilla.neo/anki";
    ...
    private void addNote(String model, String deck, ArrayList<String> fields, ArrayList<String> tags) {
        ...
        Set<String> allTags = new HashSet<>(Arrays.asList("neo"));
        allTags.addAll(tags);
